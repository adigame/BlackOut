...
if((FETCH_CONST(life_gouvlevel)) < 1) exitWith {
...
switch (FETCH_CONST(life_gouvlevel)) do 
{
	...
	case 2: { life_paycheck = life_paycheck + 600; }; //Level 2
	case 3: { life_paycheck = life_paycheck + 700; }; //Level 3
	case 4: { life_paycheck = life_paycheck + 800; }; //Level 4
	case 5: { life_paycheck = life_paycheck + 1500; }; //Level 5
	default { life_paycheck = life_paycheck; }; //default for non donators they get nada!
};
systemChat format ["Ta paye totale est de %1€",life_paycheck];
