...
_side = switch(playerSide) do {case west:{"cop"}; case east:{"gouv"}; case civilian:{"civ"}; case independent:{"med"};};
...
ctrlSetText[2009,format["Place: %1 / %2", life_carryWeight, life_maxWeight]];
