...
class Clothing {
	class bruce {
		...
		uniforms[] = {
            ...
            { "U_C_Poloshirt_burgundy", "Poloshirt Burgundy", 0, { "", "", -1 } },
            { "U_C_Poloshirt_redwhite", "Poloshirt Red/White", 0, { "", "", -1 } },
            { "U_C_Poloshirt_salmon", "Poloshirt Salmon", 0, { "", "", -1 } },
            { "U_C_Poloshirt_stripped", "Poloshirt stripped", 0, { "", "", -1 } },
            { "U_C_Poloshirt_tricolour", "Poloshirt Tricolor", 0, { "", "", -1 } },
            { "U_C_Poor_2", "Rag tagged clothes", 10, { "", "", -1 } },
            { "U_IG_Guerilla2_2", "Green stripped shirt & Pants", 30, { "", "", -1 } },
            { "U_IG_Guerilla3_1", "Brown Jacket & Pants", 35, { "", "", -1 } },
            { "U_IG_Guerilla2_3", "The Outback Rangler", 30, { "", "", -1 } },
            { "U_C_HunterBody_grn", "The Hunters Look", 50, { "", "", -1 } },
            { "U_C_WorkerCoveralls", "Mechanic Coveralls",40, { "", "", -1 } },
	...
	class cop {
		...
		vests[] = {
            ...
            { "V_PlateCarrier2_rgr", "", 100, { "life_coplevel", "SCALAR", 1 } }
		};
