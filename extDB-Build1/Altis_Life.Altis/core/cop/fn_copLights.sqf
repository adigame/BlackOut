...
switch (typeOf _vehicle) do
{
	...
	case "demian2435_swat_offroad":{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "demian2435_police_offroad":{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	...
	case "demian2435_swat_hunter":{_lightleft lightAttachObject [_vehicle, [-1, -2.8, 0.55]];};
	case "C_SUV_01_F":{_lightleft lightAttachObject [_vehicle, [-0.4, 2.3, -0.52]];};
	case "cl3_suv_black":{_lightleft lightAttachObject [_vehicle, [-0.4, 2.3, -0.52]];};
	case "demian2435_police_car":{_lightleft lightAttachObject [_vehicle, [-0.4, 2.3, -0.52]];};
	...
	case "cl3_dodge_charger_etu":{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, -0.95]];};
	...
	case "demian2435_police_helicopter":{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, -0.95]];};
};
...
switch (typeOf _vehicle) do
{
	case "C_Offroad_01_F":{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.52]];};
	case "demian2435_swat_offroad":{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.52]];};
	case "demian2435_police_offroad":{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.52]];};
	...
	case "demian2435_swat_hunter":{_lightright lightAttachObject [_vehicle, [1, 2.8, -0.55]];};
	case "C_SUV_01_F":{_lightright lightAttachObject [_vehicle, [0.38,2.2,-0.55]];};
	case "cl3_suv_black":{_lightright lightAttachObject [_vehicle, [0.38,2.2,-0.55]];};
	case "demian2435_police_car":{_lightright lightAttachObject [_vehicle, [0.4, 2.3, -0.52]];};
	...
	case "cl3_dodge_charger_etu":{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};
	...
	case "demian2435_police_helicopter":{_lightright lightAttachObject [_vehicle, [0.37, 0.0, -0.95]];};
};
