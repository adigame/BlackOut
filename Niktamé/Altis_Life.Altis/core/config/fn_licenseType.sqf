...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "contracts": {_var = "license_civ_contracts"}; //Rebel Contracts License
			...
			case "jewelry": {_var = "license_civ_jewelry"};
			case "microchips": {_var = "license_civ_microchips"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_contracts": {_var = "contracts"}; //Rebel License
			...
			case "license_civ_jewelry": {_var = "jewelry"};
			case "license_civ_microchips": {_var = "microchips"};
			default {_var = ""};
		};
	};
};
