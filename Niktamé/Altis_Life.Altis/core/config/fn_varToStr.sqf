...
switch (_var) do
{
	...
	case "life_inv_jewelry": {(localize "STR_Item_Jewelry")};
	case "life_inv_microchips": {(localize "STR_Item_Microchips")};
	case "life_inv_beer": {(localize "STR_Item_Beer")};
	case "life_inv_gpstracker": {"GPS Tracker"};
	case "life_inv_rein": {"Rein"}; 
	...
	case "license_civ_contracts": {(localize "STR_License_Rebel_Contracts")};
	...
	case "license_civ_jewelry": {(localize "STR_License_Jewelry")};
	case "license_civ_microchips": {(localize "STR_License_Microchips")};
};
