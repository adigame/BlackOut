...
switch (_filter) do
{
	...
	case 0:
	{
		if(life_job == "IRMAT") then {
			...
			["U_NikosAgedBody","Casual Wears",900],
			["U_OrestesBody","Surfing On Land",1100],
			["U_IG_Guerilla2_3","The Outback Rangler",1200],
			["U_C_HunterBody_grn","The Hunters Look",1500],
			["U_C_HunterBody_grn","U_C_Journalist",1650],
			["U_C_WorkerCoveralls","Mechanic Coveralls",2500],
			["IRMAT_Man","IRMAT",2000]
			];
	...
	case 1:
	{
		[
			...
			["Kio_Afro_Hat",nil,110],
			["Kio_Capital_Hat",nil,110],
			["Kio_Spinning_Hat",nil,110],
			["Kio_Pirate_Hat",nil,110],
			["Kio_Santa_Hat",nil,110],
			["Kio_No1_Hat",nil,110]
		];		
	};
