...
if((_this select 3) == "reb" && !license_civ_contracts) exitWith {hint localize "STR_Shop_NotaReb"; closeDialog 0;};
...
if((_this select 3) in ["gign"] && life_job != "GIGN" && playerSide != west) exitWith {hint "Vous ne faites pas parti du G.I.G.N !"; closeDialog 0;};
