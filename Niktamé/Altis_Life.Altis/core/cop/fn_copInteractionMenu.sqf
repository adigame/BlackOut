...
if(!((player distance (getMarkerPos "cop_neochori") < 30) OR  (player distance (getMarkerPos "cop_terminal") < 30) OR (player distance (getMarkerPos "cop_athira") < 30) OR (player distance (getMarkerPos "cop_kavala") < 30))) then 
{
