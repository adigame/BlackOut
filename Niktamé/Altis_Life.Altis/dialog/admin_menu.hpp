class life_admin_menu {
    ...
    class controls {
        ...
        class Teleport : Life_RscButtonMenu {
            ...
            onButtonClick = "[] call life_fnc_adminTeleport; hint 'Séléctionne où tu voudrais te téléporter';";
        ...
        class RepairBuildings : Life_RscButtonMenu {
            idc = 2911;
            text = "$STR_AdminRepairBuildings";
