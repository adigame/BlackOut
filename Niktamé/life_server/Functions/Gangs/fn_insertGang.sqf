...
if(count _queryResult != 0) exitWith {
	[[1,"Il y a déjà un gang créé avec ce nom, choisis-en un autre."],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP;
...
if(count _queryResult != 0) exitWith {
	[[1,"Tu es déjà dans un gang."],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP;
	[["life_action_gangInUse",nil,missionNamespace],"life_fnc_netSetVar",_ownerID,false] spawn life_fnc_MP;
};
