...
switch (_shop) do
{
	...
	case "speakeasy": {["La Parlotte",["bottledwhiskey","bottledshine","bottledbeer"]]};
	...
	case "cop": {["Cop Item Shop",["donuts","coffee","spikeStrip","water","rabbit","apple","redgull","fuelF","defusekit","wall"]]};
