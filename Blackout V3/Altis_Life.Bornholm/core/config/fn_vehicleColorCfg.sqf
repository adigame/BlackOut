...
switch (_vehicle) do
{
	...
	case "C_Hatchback_01_sport_F":
	{
		...
		[
			...
			["textures\Hayon\Gendarmerie.jpg","cop"]
		];
	};
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\Pickup\Gendarmerie.jpg","cop"],
			["textures\Pickup\EMS.jpg","med"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["#(ai,64,64,1)Fresnel(1.3,7)","cop"],
			["textures\Suv\Gendarmerie.jpg","cop"],
			["textures\Suv\Rebelle.jpg","reb"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["textures\Hummingbird\Ambulance.jpg","med"]
		];
	};
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			["textures\Hunter\Gendarmerie.jpg","cop","textures\Hunter\Gendarmerie_.jpg"]
		];
	};
	...
	case "DAR_ChallengerCivWhite":
	{
		_ret =
		[
			["textures\Challenger\body_coblack.paa","civ"],
			["textures\Challenger\body_co.paa","civ"],
			["textures\Challenger\body_coOrange.paa","civ"],
			["textures\Challenger\body_coRed.paa","civ"]
		];
	};
};
