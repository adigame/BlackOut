...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='icons\bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='icons\money.paa'/> <t size='0.8'>$%2</t>",[life_atmfric] call life_fnc_numberText,[life_fric] call life_fnc_numberText];
ctrlSetText[2009,format["Contenu: %1 / %2", life_carryWeight, life_maxWeight]];
{
