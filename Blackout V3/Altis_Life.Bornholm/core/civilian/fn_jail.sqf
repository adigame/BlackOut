...
*/
private["_bad","_unit","_time"]; //Time Jail
...
_time = [_this,2,15,[0]] call BIS_fnc_param;//Time Jail
...
[[player,_bad,_time],"life_fnc_jailSys",false,false] spawn life_fnc_MP;//Time Jail
