...
diag_log format["-----------------------------------------|SPYGLASS_LOG|-----------------------------------------"];
diag_log format["                              Pseudo : %1 | UID : %2 | Raison : %3                              ",_pName,_pUID,_pReason]; //Outputs to RPT for external programs to parse,log,react to.
diag_log format["--------------------------------------____|SPFLAG_END|____--------------------------------------"];