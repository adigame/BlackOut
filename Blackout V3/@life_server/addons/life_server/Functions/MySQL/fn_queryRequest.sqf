...
_query = switch(_side) do {
	case west: {_returnCount = 11; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, cop_licenses, coplevel, gign, cop_gear, blacklist FROM players WHERE playerid='%1'",_uid];};
