...
switch(_type) do
{
	case "187V": {_type = ["Meurtre véhiculé",9500]};
	case "187": {_type = ["Meurtre",80000]};
	case "901": {_type = ["Echappé de prison",6500]};
	...
	case "483": {_type = ["Traffique de drogue",9500]};
	case "459": {_type = ["Burglary",6500]};
	case "460": {_type = ["Consommation de stup",9000]};
	default {_type = [];};
};
